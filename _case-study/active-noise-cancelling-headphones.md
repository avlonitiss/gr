...
H διάδραση με τον χρήστη, στην πορεία της εξέλιξης των προϊόντων, μετατράπηκε από χειροκίνητη ρύθμιση επιπέδου απομόνωσης επί των ακουστικών, σε προ-ρυθμίσεις λεπτομερειών στην έξυπνη συσκευή που ελέγχει το περιβάλλον των ακουστικών.
